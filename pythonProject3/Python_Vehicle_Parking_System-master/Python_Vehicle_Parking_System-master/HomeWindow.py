...
class HomeScreen(QMainWindow):
    ...
    def showManage(self):
        self.btn_home.setStyleSheet(
            "width:200px;height:160px;font-size:20px;background:orange;"
            "color:#fff;font-weight:bold;border:1px solid white")
        self.btn_add.setStyleSheet(
            "width:200px;height:160px;font-size:20px;background:orange;color:#fff;"
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3] == 1:
                label.setStyleSheet(
                    "background-color:green;color:white;padding:5px;width:100px;"
                    "height:100px;border:1px solid white;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet(
                    "background-color:red;color:white;padding:5px;width:100px;"
                    "height:100px;border:1px solid white;text-align:center;font-weight:bold")
    ...
    def addHomePageData(self):
        ...
        for data in alldata:
            ...
            if data[3] == 1:
                label.setStyleSheet(
                    "background-color:green;color:white;padding:5px;width:100px;height:100px;border:1px solid white;"
    ...
    def addAddStudentPage(self):
        ...
        vehicle_type: QLabel | QLabel = QLabel("Vehicle Type : ")
    ...
    def addVehicles(self, name, vehicleno, mobile, index, error_label):
        ...
        data: bool | str = self.dbOperation.AddVehicles(name, vehicleno, mobile, str(vtp))
        if data == True:
    ...
    def exitCall(self):
        btton: HomeScreen | None = self.sender()
        if btton:
